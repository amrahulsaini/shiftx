...
export default function HomePage() {
  ...
  const reviews = [
    ...
    { name: "Amit Patel", rating: 5, text: "Great experience with Easy Swift. Affordable pricing and careful handling of all items.", location: "Ahmedabad" },
    ...
    <div className="min-h-screen" style={{background: '#FFFFFF'}}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex flex-col">
              <h1 className="text-2xl md:text-3xl font-bold" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Easy Swift Packers and Movers</h1>
              <p className="text-xs md:text-sm" style={{color: '#FF6B35'}}>Your Trusted Moving Partner Since 2025</p>
            </div>
      ...
      <section className="text-white py-20 md:py-32 px-4 relative" style={{
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 animate-fade-in-up" style={{color: '#FFFFFF', fontFamily: 'var(--font-museo-moderno)', textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>Welcome to Easy Swift Packers and Movers</h2>
          <p className="text-xl md:text-2xl lg:text-3xl mb-8 animate-fade-in-up" style={{color: '#FFFFFF', animationDelay: '0.2s', fontFamily: 'var(--font-source-sans-3)', textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>Professional Relocation Services Across PAN India</p>
          <div className="flex flex-wrap justify-center gap-4 mb-10 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
            <div className="flex items-center gap-2 px-6 py-3" style={{background: '#FFFFFF', color: '#000000', border: '2px solid #FF6B35'}}><Award className="w-5 h-5" style={{color: '#FF6B35'}} /><span className="font-medium">Est. 2025</span></div>
            <div className="flex items-center gap-2 px-6 py-3" style={{background: '#FFFFFF', color: '#000000', border: '2px solid #FF6B35'}}><Clock className="w-5 h-5" style={{color: '#FF6B35'}} /><span className="font-medium">24x7 Support</span></div>
            <div className="flex items-center gap-2 px-6 py-3" style={{background: '#FFFFFF', color: '#000000', border: '2px solid #FF6B35'}}><Truck className="w-5 h-5" style={{color: '#FF6B35'}} /><span className="font-medium">Door-to-Door</span></div>
            <div className="flex items-center gap-2 px-6 py-3" style={{background: '#FFFFFF', color: '#000000', border: '2px solid #FF6B35'}}><Shield className="w-5 h-5" style={{color: '#FF6B35'}} /><span className="font-medium">Insured</span></div>
          </div>
          <a href="#contact" className="inline-block px-10 py-4 text-lg font-bold shadow-2xl hover:shadow-3xl transition-all transform hover:scale-105 animate-pulse-glow" style={{background: '#FF6B35', color: '#FFFFFF', fontFamily: 'var(--font-museo-moderno)'}}>Get Free Quote Now</a>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <div key={index} className="text-center p-6 rounded-none" style={{border: '1px solid #000000'}}>
                ...
                <div className="text-3xl md:text-4xl font-bold mb-2" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>{stat.value}</div>
      ...
      <section id="about" className="py-20 px-4" style={{background: '#000000'}}>
        <div className="max-w-7xl mx-auto">
          <h3 className="text-4xl md:text-5xl font-bold text-center mb-4 animate-fade-in-up" style={{color: '#FFFFFF', fontFamily: 'var(--font-museo-moderno)'}}>About Us</h3>
          <p className="text-center text-lg mb-12 max-w-3xl mx-auto" style={{color: '#FFFFFF'}}>Your trusted relocation partner with commitment to excellence</p>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 animate-slide-in-left" style={{background: '#FFFFFF', border: '1px solid #FF6B35'}}>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-2xl font-semibold" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Company Overview</h4>
              </div>
              <div className="space-y-4" style={{color: '#333333', fontFamily: 'var(--font-source-sans-3)'}}>
                <div className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 mt-1 flex-shrink-0" style={{color: '#FF6B35'}} /><div><strong>Company Name:</strong> Easy Swift Packers and Movers</div></div>
                <div className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 mt-1 flex-shrink-0" style={{color: '#FF6B35'}} /><div><strong>Established:</strong> 2025</div></div>
            ...
            <div className="p-8 animate-slide-in-right" style={{background: '#FFFFFF', border: '1px solid #FF6B35'}}>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-2xl font-semibold" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Certifications & Licenses</h4>
              </div>
              <div className="space-y-4" style={{color: '#333333', fontFamily: 'var(--font-source-sans-3)'}}>
                ...
                <div className="p-6 mt-6" style={{background: '#000000', color: '#FFFFFF', border: '1px solid #FF6B35'}}>
                  <div className="flex items-start gap-3">
                    ...
                    <div><p className="text-lg font-bold mb-2" style={{color: '#FFFFFF'}}>💼 Insurance Coverage Available</p><p style={{color: '#FFFFFF'}}>Comprehensive insurance coverage for your valuable goods during transit, ensuring complete peace of mind throughout the moving process.</p></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="services" className="py-20 px-4" style={{background: '#FFFFFF'}}>
        <div className="max-w-7xl mx-auto">
          <h3 className="text-4xl md:text-5xl font-bold text-center mb-4" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Our Services</h3>
          <p className="text-center text-lg mb-12 max-w-3xl mx-auto" style={{color: '#333333'}}>Comprehensive Moving Solutions Tailored to Your Needs</p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <div key={index} className="p-6 text-center transition-transform duration-300 hover:scale-105" style={{background: '#FFFFFF', border: '1px solid #000000', animationDelay: `${index * 0.1}s`}}>
                ...
                <h4 className="text-xl font-bold mb-2" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>{service.name}</h4>
      ...
      <section className="py-20 px-4" style={{background: '#000000'}}>
        <div className="max-w-7xl mx-auto">
          <h3 className="text-4xl md:text-5xl font-bold text-center mb-4" style={{color: '#FFFFFF', fontFamily: 'var(--font-museo-moderno)'}}>Why Choose Easy Swift?</h3>
          <p className="text-center text-lg mb-12 max-w-3xl mx-auto" style={{color: '#FFFFFF'}}>Your Satisfaction is Our Priority</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6" style={{background: '#FFFFFF', border: '1px solid #FF6B35'}}><Shield className="w-12 h-12 mb-4" style={{color: '#FF6B35'}} /><h4 className="text-2xl font-bold mb-3" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Insurance Coverage</h4><p style={{color: '#333333'}}>Comprehensive insurance protection for all your valuable belongings during the entire moving process.</p></div>
            <div className="p-6" style={{background: '#FFFFFF', border: '1px solid #FF6B35'}}><Clock className="w-12 h-12 mb-4" style={{color: '#FF6B35'}} /><h4 className="text-2xl font-bold mb-3" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>24x7 Support</h4><p style={{color: '#333333'}}>Round-the-clock customer support to assist you at every step of your relocation journey.</p></div>
            <div className="p-6" style={{background: '#FFFFFF', border: '1px solid #FF6B35'}}><Award className="w-12 h-12 mb-4" style={{color: '#FF6B35'}} /><h4 className="text-2xl font-bold mb-3" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Certified & Licensed</h4><p style={{color: '#333333'}}>ISO certified and IBA approved with valid GST registration for quality assurance.</p></div>
            <div className="p-6" style={{background: '#FFFFFF', border: '1px solid #FF6B35'}}><Truck className="w-12 h-12 mb-4" style={{color: '#FF6B35'}} /><h4 className="text-2xl font-bold mb-3" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Door-to-Door Service</h4><p style={{color: '#333333'}}>Complete door-to-door service - no hassle of pick-up or drop-off!</p></div>
            <div className="p-6" style={{background: '#FFFFFF', border: '1px solid #FF6B35'}}><TrendingUp className="w-12 h-12 mb-4" style={{color: '#FF6B35'}} /><h4 className="text-2xl font-bold mb-3" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Transparent Pricing</h4><p style={{color: '#333333'}}>No hidden charges - get honest and competitive quotes with clear breakdowns.</p></div>
            <div className="p-6" style={{background: '#FFFFFF', border: '1px solid #FF6B35'}}><Users className="w-12 h-12 mb-4" style={{color: '#FF6B35'}} /><h4 className="text-2xl font-bold mb-3" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Expert Team</h4><p style={{color: '#333333'}}>Trained and experienced professionals for safe handling of your belongings.</p></div>
          </div>
        </div>
      </section>
      ...
      <section id="reviews" className="py-20 px-4" style={{background: '#FFFFFF'}}>
        <div className="max-w-7xl mx-auto">
          <h3 className="text-4xl md:text-5xl font-bold text-center mb-4" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>What Our Customers Say</h3>
          <p className="text-center text-lg mb-12" style={{color: '#333333'}}>Don't just take our word for it - hear from our satisfied customers</p>
      ...
      <section id="faq" className="py-20 px-4" style={{background: '#FFFFFF'}}>
        <div className="max-w-4xl mx-auto">
          <h3 className="text-4xl md:text-5xl font-bold text-center mb-4" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Frequently Asked Questions</h3>
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="overflow-hidden" style={{background: '#FFFFFF', border: '1px solid #000000'}}>
                <button onClick={() => setOpenFaq(openFaq === index ? null : index)} className="w-full p-6 text-left flex items-center justify-between transition">
                  <span className="font-bold text-lg" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>{faq.q}</span>
      ...
      <section id="contact" className="py-20 px-4" style={{background: '#FFFFFF'}}>
        <div className="max-w-7xl mx-auto">
          <h3 className="text-4xl md:text-5xl font-bold text-center mb-4" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Contact Us</h3>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="space-y-6">
              ...
              <div className="p-6 flex items-start gap-4 transition" style={{background: '#FFFFFF', border: '1px solid #000000'}}><div className="p-3" style={{background: '#000000'}}><MapPin className="w-6 h-6 text-white" /></div><div><h4 className="font-bold text-lg mb-1" style={{color: '#000000'}}>Office Address</h4><p style={{color: '#333333'}}>123 Main Street, Business District, City, State, India - 110001</p></div></div>
            </div>
            <div className="p-8" style={{background: '#FFFFFF', border: '1px solid #000000'}}>
              <h4 className="text-2xl font-bold mb-6" style={{color: '#000000', fontFamily: 'var(--font-museo-moderno)'}}>Send Us a Message</h4>
              <form className="space-y-5">
                ...
                <button type="submit" className="w-full py-4 text-white font-bold text-lg hover:opacity-90 transition" style={{background: '#FF6B35', fontFamily: 'var(--font-museo-moderno)'}}>Send Message</button>
              </form>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              <h5 className="text-2xl font-bold mb-4" style={{color: '#FFFFFF', fontFamily: 'var(--font-museo-moderno)'}}>Easy Swift Packers and Movers</h5>
              <p className="text-white text-opacity-80 mb-4">Your trusted partner for seamless relocation across PAN India since 2025. We handle your belongings with care and professionalism.</p>
            ...
            <div>
              <h6 className="text-lg font-bold mb-4" style={{color: '#FFFFFF', fontFamily: 'var(--font-museo-moderno)'}}>Quick Links</h6>
            ...
            <div>
              <h6 className="text-lg font-bold mb-4" style={{color: '#FFFFFF', fontFamily: 'var(--font-museo-moderno)'}}>Legal Info</h6>
          ...
          <div className="border-t border-white border-opacity-20 pt-8 text-center">
            <p className="text-white text-opacity-80 mb-2">&copy; 2025 Easy Swift Packers and Movers. All rights reserved.</p>
